...
function DetailsDriver() {
  ...
  const getResturents = async () => {
    ...
    setLoading(true);
    const res = await axios.get("https://food-backend-grng.onrender.com/api/drivers", {
      headers: {
                  ...
                  <div class="flex items-center space-x-4">
                    ...
                    <div class="inline-flex items-center text-base font-semibold text-gray-900 ">
                      <div className="flex space-x-2">
                        ...
                        <DeleteFilled className="text-red-600 text-xl cursor-pointer" onClick={() => deleteUser(res._id)}/>
                      </div>
                    </div>
                  </div>
                </li>
